...
exports.validatorForAddMark  = [
    ...
    body('k_1_1_1','Заполните все обязательные поля!').toInt().isInt(),
    body('k_1_1_2','Заполните все обязательные поля!').toInt().isInt(),
    body('k_1_1_3','Заполните все обязательные поля!').toInt().isInt(),
    body('k_1_2_1','Заполните все обязательные поля!').toInt().isInt(),
    ...
    body('k_3_1_1','Заполните все обязательные поля!').toInt().isInt(),
    body('k_3_2_1','Заполните все обязательные поля!').toInt().isInt(),
