            ...
            if(req.params.project_id == 2) {
                ...
                if(req.body.id_teacher && req.body._csrf) {
                    ...
                    for(let i = 0; i < card.length; i++) {
                        ...
                        }else if(card[i].interest > 50 && card[i].interest <= 75) {
...
exports.addMarkForTeacherAll = async (req, res) => {
    try{
        ...
        if(req.session.user) {
            ...
            return res.render('school_teacher_card_add_mark_all', {
                layout: 'maincard',
                title: 'Оценить урок',
                teacher,
                teacher_id,
    ...
    try{
        ...
        if(req.session.user) {
            ...
            if(req.body.id_teacher && req.body._csrf) {
                ...
                if(!errors.isEmpty()) {
                    req.flash('error', error_base.empty_input)
                    return res.status(422).redirect('/school/card/add/project/' + project_id + '/teacher/' + teacher_id + '/method')
                }
            ...
            return res.render('school_teacher_card_add_mark_method', {
                layout: 'maincard',
                title: 'Оценить урок',
                teacher,
                teacher_id,
            ...
            if(req.params.project_id == 2) {
               ...
               // let interest = commonValue;
                ...
                if(interest > 75) {
                    ...
                    expertRes = "высокий уровень соответствия урока (занятия) требованиям ФГОС";
                    levelText = "системно-деятельностный подход реализован на уроке в полной мере"
                    levelStyle = 'success';

                }else if(interest > 50 && interest <= 75) {
                    level = "Базовый уровень (оптимальный)";
                    expertRes = "средний уровень соответствия урока (занятия) требованиям ФГОС";
                    levelText = "системно-деятельностный подход реализован на уроке частично, в отдельных учебных ситуациях"
                    levelStyle = 'good';

                } else if(interest <= 50) {
                    level = 'Ниже базового уровня (критический)';
                    expertRes = "низкий уровень соответствия урока (занятия) требованиям ФГОС";
                    levelText = "системно-деятельностный подход не реализован"
                    levelStyle = 'danger';
                }
                ...
                if(req.body.excel_tbl) {
                    ...
                    worksheet.columns = [
                        ...
                        { header: 'Вывод', key: 'levelText', width: 30},
    ...
    try{
        ...
        if(req.session.user) {
            ...
            if(req.params.project_id == 2) {
               ...
               let commonValue = singleCard[0].k_2_1_1 + singleCard[0].k_2_1_2 + singleCard[0].k_2_1_3 + singleCard[0].k_2_1_4 + singleCard[0].k_2_2_1 + singleCard[0].k_2_2_2
               + singleCard[0].k_2_2_3 + singleCard[0].k_2_2_4 + singleCard[0].k_2_2_5 + singleCard[0].k_2_2_6 + singleCard[0].k_2_2_7
               + singleCard[0].k_2_2_8 + singleCard[0].k_2_2_9 + singleCard[0].k_2_2_10 + singleCard[0].k_2_3_1 + singleCard[0].k_2_3_2
               + singleCard[0].k_2_3_3 + singleCard[0].k_2_3_4 + singleCard[0].k_2_3_5 + singleCard[0].k_2_3_6 + singleCard[0].k_2_3_7
               + singleCard[0].k_2_4_1 + singleCard[0].k_2_4_2 + singleCard[0].k_2_4_3 + singleCard[0].k_2_4_4 + singleCard[0].k_2_4_5
               + singleCard[0].k_2_4_6 + singleCard[0].k_2_4_7 + singleCard[0].k_2_5_1 + singleCard[0].k_2_5_2

                let interest = Math.round((commonValue * 100) / 46);
                    ...
                    doc.addSection({
                        children: [
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.1. Учитель демонстрирует умение организовывать целеполагание на уроке (занятии): ',
                                        bold:true,
                                    }),
                                    new TextRun('  ')]
                            }),
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.1.1. учитель формулирует цель урока (занятия)  вместе с обучающимися, используя проблемную ситуацию (задачу), смысловые догадки, метод ассоциаций и иное',
                                        bold:true
                                    })]
                            }),
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.1.2. цель урока (занятия) сформулирована так, что ее достижение можно проверить',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.1.3. цель урока (занятия) сформулирована четко и понятно для обучающихся',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.1.4. этапы (задачи) урока (занятия) соответствуют достижению цели, являются необходимыми и достаточными',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2. Учитель демонстрирует умение организовывать разнообразные виды  деятельности обучающихся, которые обеспечивают достижение цели урока (занятия):',
                                        bold:true,
                                    }),
                                    new TextRun('  ')]
                            }),
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.1. учитель использует проблемные методы обучения (частично-поисковый, исследовательский), приемы активизации познавательной деятельности обучающихся, диалоговые технологии',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.2. учитель организует самостоятельную поисковую активность обучающихся',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.3. учитель организует проектную / учебно-исследовательскую деятельность обучающихся или использует проектные и исследовательские задания',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.4. учитель использует задания, которые предусматривают учет индивидуальных особенностей и интересов обучающихся, дифференциацию и индивидуализацию обучения, в том числе возможность выбора темпа, уровня сложности, способов деятельности ',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.5. учитель использует задания на формирование / развитие / совершенствование универсальных учебных действий',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.6. учитель использует задания, направленные на формирование положительной учебной мотивации, в том числе учебно-познавательных мотивов',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.7. учитель использует разнообразные способы и средства обратной связи',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.8. качество и количество заданий обеспечивают достижение цели урока (занятия)',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.9. учитель использует методы и приемы, обеспечивающие достижение планируемых результатов урока (занятия)',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.2.10. выбранный тип урока (занятия) соответствует поставленной цели, структура урока (занятия) логична, этапы взаимосвязаны',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3. Учитель демонстрирует умение организовывать оценку и рефлексию на уроке (занятии):',
                                        bold:true,
                                    }),
                                    new TextRun('  ')]
                            }),
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3.1. учитель использует формирующее (критериальное) оценивание',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3.2. учитель организует разработку / обсуждение критериев оценки деятельности с обучающимися',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3.3. учитель организует взаимооценку / самооценку',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3.4. учитель содержательно (опираясь на критерии оценки) комментирует выставленные отметки',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3.5. учитель организует рефлексию с учетом возрастных особенностей обучающихся (учитель предлагает обучающимся оценить новизну, сложность, полезность выполненных заданий, уровень достижения цели урока (занятия), степень выполнения поставленных задач, полученный результат и деятельность, взаимодействие, иное)',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3.6. учитель вместе с детьми оценивает практическую значимость знаний и способов деятельности',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.3.7. соответствие содержания урока (занятия) планируемым результатам',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4. Информационное и техническое обеспечение урока (занятия)',
                                        bold:true,
                                    }),
                                    new TextRun('  ')]
                            }),
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4.1. учитель использует условно-изобразительную наглядность (знаково-символические средства, модели и др.), использование наглядности целесообразно',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4.2. учитель использует ИКТ-технологии, применение технологий целесообразно',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4.3. учитель использует наглядность для решения определенной учебной задачи. Средства обучения используются целесообразно с учетом специфики программы, возраста обучающихся',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4.4. учитель использует разнообразные справочные материалы (словари, энциклопедии, справочники)',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4.5. учитель использует электронные учебные материалы и ресурсы Интернета',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4.6. учитель использует материалы разных форматов (текст, таблица, схема, график, видео, аудио)',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.4.7. учитель использует технологическую карту урока (занятия)',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.5. Обеспечение условий охраны здоровья обучающихся',
                                        bold:true,
                                    }),
                                    new TextRun('  ')]
                            }),
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.5.1. учитель чередует различные виды деятельности обучающихся',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
                            ...
                            new Paragraph({
                                children: [
                                    new TextRun({
                                        text: '1.5.2. учитель организует динамические паузы (физкультминутки) и (или) проведение комплекса упражнений для профилактики сколиоза, утомления глаз',
                                        bold:true
                                    })]
                            }),
                            new Paragraph({
